...
export const AboutMe: React.FC = () => {
  return (
    <PageLayout>
      <section className="w-full h-auto px-4 py-6">
        ...
        `}
            ...
            <p className="bg-gray-50 p-2 shadow-sm rounded-sm">{`Loyalty is a two-way street. If I'm asking for it from you,then you're getting it from me" H.Specter from Suits`}</p>
          </div>
        </div>
      </section>
    </PageLayout>
